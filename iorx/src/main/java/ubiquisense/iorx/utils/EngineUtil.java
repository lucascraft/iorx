...
//				if (queue.getTtl() < delay) {
//					if (Platform.inDebugMode()) {
//						System.out.println(queue.getClass().getName() + " Cmd FLUSH BECAUSE OF delay over TTL : " + delay + " > "+ queue.getTtl());
//					}
//					queue.eSetDeliver(false);
...
//							if (qx.getMax() < size) {
//								if (Platform.inDebugMode()) {
//									System.out.println("THRESHOLD " + qx.getClass().getName() + " of "+ qx.getMax() + " RAISED !!!");
//								}
...
//									if (qx.getTtl() < delay) {
//										if (Platform.inDebugMode()) {
//											System.out.println(qx.getClass().getName() +  " Cmd FLUSH BECAUSE OF delay over TTL : " + delay + " > "+ qx.getTtl());
//										}
//										qx.eSetDeliver(false);
